  ...
  <div class="${properties.kcLoginContainer!}">
    <main class="${properties.kcLoginMain!}">
      ...
      <div class="${properties.kcLoginMainHeader!}">
       <img src="${url.resourcesPath}/img/login-bg.svg" class="custom-login-bg"/>
      </div>
      </div>
      <div class="${properties.kcLoginMainBody!}">
    <div style="padding:16px;display:flex;align-items:center;justify-content:center;flex-direction:column">
      <div class="branding-container">
        <div class="logo-container">
            <img src="${url.resourcesPath}/img/intugine.png" alt="logo" class="logo">
            <h3 class="brand-title">Intugine Technologies</h3>
        </div>
        <p class="slogan">Logistics Through Innovation</p>
        <div class="button">Intracity</div>
    </div>
